...
class CP_Pinyin {
    ...
    public function output($str, $utf8 = true) {
    	...
    	$str = ($utf8==true) ? $this->_iconvStr('utf-8', 'gbk', $str) : $str;
    	$num = strlen($str);
    	$pinyin = '';
    	for ($i=0; $i<$num; $i++) {
            ...
            $pinyin .= $this->_numTostr($temp);
        }
        return ($utf8==true) ? $this->_iconvStr('gbk', 'utf-8', $pinyin) : $pinyin;
    }
     ...
     * @return string
     */
    protected function _numTostr($num) {
        if (!$this->lib) {          
            $this->_parseLib();
        }
     ...
     * @return string
     */
    protected function _iconvStr($from, $to, $fContents) {
